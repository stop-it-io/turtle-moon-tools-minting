                ...
                <Grid item md={6}>
                  <Grid item xs={12}>
                    ...
                    <Checkbox
                      ...
                      inputProps={{ 'aria-label': 'controlled' }}
                    /> I already uploaded my images and metadata to IPFS
                    <br />
                    <br />
                    <span>
                      Select the JSON file with already created METADATA CIDs (ordered highest to lowest #, top to bottom) that ALREADY have images uploaded to IPFS and linked in that metadata:
                    </span>
                    <br />
              ...
              <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 1, md: 3 }}>
                <Grid item md={6}>
                  <Grid item xs={12}>
                    ...
                    <br />{' '}
                    May show broken image. Most Filetypes are supported. Verify if working on testnet mint. Display of more filetypes coming soon.
                  </Grid>
                  <Grid item xs={12}>
                      <Button
